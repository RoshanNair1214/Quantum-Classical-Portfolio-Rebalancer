...
We selected 25 volatile NSE stocks across IT, Banking, FMCG, Auto, and Healthcare, covering ~70% of the NIFTY 50 weightage. We mapped these into a **Quadratic Unconstrained Binary Optimization (QUBO)** problem where $Energy = Risk + Penalty$.

### Phase 3: Hybrid Optimization
Using **QAOA**, we ran a variational loop where the **Quantum Side** (Gamma/Beta parameters) and **Classical Side** (COBYLA) collaborated to find the ground state. We achieved an optimal energy state of **-49.997**, proving the 10-stock budget constraint was met.
